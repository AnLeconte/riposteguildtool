...
export async function executeAdvanced(simId: string): Promise<void> {
  ...
  try {
    ...
    // For advanced mode, the simc_input is used directly as the profile
    ...
    try {
      ...
      // No profileset results — that's fine
    }
